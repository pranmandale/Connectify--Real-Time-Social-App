...
const Feed = () => {
  const stories = [
    ...
    { id: 5, name: "sarah_jones", avatar: "/diverse-user-avatars.png", isOwn: false },
    { id: 6, name: "john_doe", avatar: "/diverse-user-avatars.png", isOwn: false },
    { id: 7, name: "jane_smith", avatar: "/diverse-user-avatars.png", isOwn: false },
    { id: 8, name: "mike_wilson", avatar: "/diverse-user-avatars.png", isOwn: false },
    { id: 9, name: "sarah_jones", avatar: "/diverse-user-avatars.png", isOwn: false },
  ]
  ...
  return (
    <div className="flex-1 bg-white/80 backdrop-blur-sm min-h-screen lg:h-screen relative lg:overflow-y-auto scrollbar-hide">
      ...
      <div className="pb-20">
        {posts.map((post) => (
          <div key={post.id} className="border-b border-gray-200 mb-4">
            {/* Post Header */}
            <div className="flex items-center justify-between p-4">
              <div className="flex items-center space-x-3">
                <img src={post.avatar || "/placeholder.svg"} alt={post.user} className="w-10 h-10 rounded-full" />
                <div>
                  <p className="text-gray-800 font-medium">{post.user}</p>
            ...
            <div className="p-4">
              ...
              {/* Likes */}
              <p className="text-gray-800 font-medium mb-2">{post.likes.toLocaleString()} likes</p>
